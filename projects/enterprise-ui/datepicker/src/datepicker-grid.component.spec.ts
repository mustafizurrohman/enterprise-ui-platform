...
import { type DatepickerGridContext, type DatepickerWeek } from './datepicker-grid.types';
...
describe('DatepickerGridComponent', () => {
  ...
  it('should expose unique IDs for rendered grid elements', () => {
    ...
    expect(fixture.nativeElement.querySelector('[data-testid="datepicker-weekday-row"]').id).toBe(
      'calendar-grid-weekday-row',
    );
    expect(fixture.nativeElement.querySelector('[data-testid="datepicker-week-1"]').id).toBe(
  ...
  it('should emit selection, focus and keyboard events', () => {
    ...
    expect(dateKeydownSpy).toHaveBeenCalledWith(expect.objectContaining({ date: selectedDate }));
  ...
  it('should focus the requested date', () => {
    ...
    expect(document.activeElement).toBe(
      fixture.nativeElement.querySelector('[data-testid="datepicker-day-2026-07-15"]'),
    );
  });
