...
describe('DatepickerDialogComponent', () => {
  ...
  beforeEach(async () => {
    ...
    const context: DatepickerDialogContext = {
      ...
      daysOfWeek: Info.weekdays('short', { locale: 'de' }).map((short, index) => ({
        short,
  ...
  it('should present month and year as balanced navigation groups', () => {
    const header = fixture.nativeElement.querySelector('.datepicker-header') as HTMLElement;
    const navigationGroups = header.querySelectorAll('.datepicker-navigation-group');
    const periodControls = header.querySelectorAll('.datepicker-period-control');
    const divider = header.querySelector('.datepicker-navigation-divider') as HTMLElement;
  ...
  it('should integrate each current-period action with its value control', () => {
    ...
    expect(
      monthPeriodControl.querySelector('[data-testid="datepicker-month-select"]'),
    ).toBeTruthy();
    expect(monthPeriodControl.querySelector('[data-testid="datepicker-month-reset"]')).toBeTruthy();
    expect(yearPeriodControl.querySelector('[data-testid="datepicker-year-display"]')).toBeTruthy();
    expect(yearPeriodControl.querySelector('[data-testid="datepicker-year-reset"]')).toBeTruthy();
  });
  ...
  it('should group month and year navigation with their related controls', () => {
    ...
    const monthControls = monthGroup.querySelector('.datepicker-navigation-controls')!;
    expect(monthControls.querySelector('[data-testid="datepicker-previous-month"]')).toBeTruthy();
    expect(monthControls.querySelector('[data-testid="datepicker-month-select"]')).toBeTruthy();
    expect(monthControls.querySelector('[data-testid="datepicker-month-reset"]')).toBeTruthy();
    expect(monthControls.querySelector('[data-testid="datepicker-next-month"]')).toBeTruthy();

    const yearControls = yearGroup.querySelector('.datepicker-navigation-controls')!;
    expect(yearControls.querySelector('[data-testid="datepicker-previous-year"]')).toBeTruthy();
    expect(yearControls.querySelector('[data-testid="datepicker-year-display"]')).toBeTruthy();
    expect(yearControls.querySelector('[data-testid="datepicker-year-reset"]')).toBeTruthy();
    expect(yearControls.querySelector('[data-testid="datepicker-next-year"]')).toBeTruthy();
  });
  ...
  it('should hide AM/PM for a 24-hour time format', () => {
    expect(
      fixture.nativeElement.querySelector('[data-testid="datepicker-meridiem-toggle"]'),
    ).toBeNull();
  ...
  it('should render an accessible AM/PM toggle after the last time wheel', () => {
    ...
    expect(
      secondControl.compareDocumentPosition(group) & Node.DOCUMENT_POSITION_FOLLOWING,
    ).toBeTruthy();
  });
